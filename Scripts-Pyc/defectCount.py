...
def defectExcel(FileName):
    ...
    valid_defects = [statusList.get('A-Assigned',0),statusList.get('N-New',0),statusList.get('O-Opened',0),
                     statusList.get('I-Info_req',0),statusList.get('P-Postponed',0),statusList.get('R-Resolved',0),statusList.get('V-Verified',0)]#get valid defects and store in list
